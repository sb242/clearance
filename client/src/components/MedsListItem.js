...
export default function MedsListItem(props) {
  ...
  // const editRender = (name, text, record) => {
      ...
      <div >
        <Form form={form}
          onFinish={(values) => {
            console.log(values);
            editMedicine(values);
            // const updatedMedicine = [...props.medicine];
            // updatedMedicine.splice(editingRow, 1, { ...values, key: editingRow });
            // props.setMedicine(updatedMedicine);
